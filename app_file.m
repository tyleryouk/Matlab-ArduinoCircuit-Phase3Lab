classdef app_file < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        LPFilterCutoffEditField       matlab.ui.control.NumericEditField
        LPFilterCutoffEditFieldLabel  matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function UIFigureButtonDown(app, event)
            ...
            times = TimeVec(:);  %% ORIGINAL = times = RecData(:,2)
            %computing dt  
  ...
  % UNMUTE %app.valueofFrequencyLabel.text = F %saving F as app property
  % UNMUTE %app.valueofdtLabel.text = dt %saving dt as app property
 ...
 %%
        ...
        % Value changed function: LPFilterCutoffEditField
        function LPFilterCutoffEditFieldValueChanged(app, event)
            value = app.LPFilterCutoffEditField.Value;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            ylabel(app.UIAxes, 'Photoresistor Light Intensity (0 to 100)')
            zlabel(app.UIAxes, 'Z')
            ...
            app.PlottoShowButtonGroup.Position = [325 444 123 106];
            ...
            app.FilterOrderSliderLabel.Position = [567 444 66 22];
            ...
            app.FilterOrderSlider.Position = [525 495 150 3];
            app.FilterOrderSlider.Value = 1;


            % Create LPFilterCutoffEditFieldLabel
            app.LPFilterCutoffEditFieldLabel = uilabel(app.UIFigure);
            app.LPFilterCutoffEditFieldLabel.HorizontalAlignment = 'right';
            app.LPFilterCutoffEditFieldLabel.Position = [470 528 86 22];
            app.LPFilterCutoffEditFieldLabel.Text = 'LP Filter Cutoff';

            % Create LPFilterCutoffEditField
            app.LPFilterCutoffEditField = uieditfield(app.UIFigure, 'numeric');
            app.LPFilterCutoffEditField.ValueChangedFcn = createCallbackFcn(app, @LPFilterCutoffEditFieldValueChanged, true);
            app.LPFilterCutoffEditField.Position = [571 528 100 22];
